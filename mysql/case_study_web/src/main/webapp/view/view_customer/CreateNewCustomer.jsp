...
<div class="row background">
    <div class="col-lg-5 col-sm-12">
        <form method="post" action="CustomerServlet?action=create">
            <fieldset>
                <table>
                    <tr class="mb-3">
                        <td> * Input New ID:</td>
                    ...
                    <tr class="mb-3">
                        ...
                        <td>
                            <select name="typeId" type="number">
                                <c:forEach var="customerTypeList" items="${customerTypeList}">
                                    <option class="form-control" value="${customerTypeList.getTypeId()}">${customerTypeList.getTypeName()}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
    ...
    <div class="col-lg-7 col-sm-12 ">
        <img src="https://furamavietnam.com/wp-content/uploads/2018/10/Vietnam_Danang_Furama_Resort_Exterior_Courtyard-1.jpg"
             width="100%" style="padding-top: 27px">
    </div>
</div>
