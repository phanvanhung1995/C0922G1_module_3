...
public class ProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "view":
                ...
                break;
            case "seach":
                showSeachForm(request,response);
                break;
            default:
    ...
    private void showSeachForm(HttpServletRequest request, HttpServletResponse response) {
        String name = request.getParameter("seach");
        List<Product> products = productService.findByName(name);
        request.setAttribute("products",products);
        request.setAttribute("name",name);
        try {
            request.getRequestDispatcher("/view/viewName.jsp").forward(request,response);
        } catch (ServletException e) {
