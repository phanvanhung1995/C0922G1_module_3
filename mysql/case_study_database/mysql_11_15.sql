...
select h.ma_hop_dong, n.ho_ten as ho_ten_nhan_vien, k.ho_ten as ho_ten_khach_hang, k.so_dien_thoai as sdt_khach_hang, d.ten_dich_vu,
...
select di.ma_dich_vu_di_kem, di.ten_dich_vu_di_kem, di.gia, di.don_vi,di.trang_thai,sum(ho.so_luong) as so_luong
